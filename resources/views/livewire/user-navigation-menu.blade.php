<div
    ...
    >
    <div>
        <nav x-ref="nav"  :style="(!showNav && !isMobileMenuOpen ) ? 'margin-top: -'+navHeight+'px': 'margin-top:0px;' " class="fixed  w-screen bg-white border-b border-gray-300  px-8 z-50 transition-all duration-300 ease-in-out"  
                wire:loading.class="cursor-wait"
            >
                <!-- Primary Navigation Menu -->
                <div class="container mx-auto flex flex-wrap justify-between items-center">
                        <div class="max-md:order-1  md:order-2" @click="isMobileMenuOpen = false">
    ...
    <div :style="`padding-top: ${navHeight}px`" > </div>
    <div id="megamenu" class=""></div>
</div>
