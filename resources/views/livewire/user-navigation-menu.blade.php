                                ...
                                <div class="flex items-center space-x-2 ">
                                    <div class="relative" x-data="{ open: false, modalOpen: false, selectedMessage: null  }">
                                        ...
                                        <button @click="open = !open" class="block ">
                                            <span class="relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" class="fill-[#333] hover:fill-[#077bff] stroke-1 inline" viewBox="0 0 512 512" stroke-width="100">
                                                    <g>
                                                        <g>
                                                            <g>
                                                                <g>
            ...
            <div class="max-w-6xl mx-auto px-3">
                <div class="flex items-stretch justify-between text-[11px] sm:text-xs text-gray-600">
                    ...
                    @if(\App\Models\Setting::enabled('webcontent', 'blog_enabled', false))
                        ...
                        <a href="/blog"
                        class="flex-1 flex flex-col items-center justify-center py-2 gap-1 "
                        :class="{'text-primary-600' : '{{ request()->is('blog') || request()->is('posts/*') ? 'true' : 'false' }}' === 'true'}"
                        >
