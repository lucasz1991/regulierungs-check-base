        ...
        <x-slot name="content">
            ...
            <div x-show="step == 3"  x-cloak  x-collapse.duration.1000ms>
                ...
                <div class="flex justify-center items-center">
                    <div x-data="{ regulationType: @entangle('regulationType') }" class="grid grid-cols-2 lg:grid-cols-4  gap-4 w-fit justify-center">
                        <style>
                            svg.bicolor .a{
