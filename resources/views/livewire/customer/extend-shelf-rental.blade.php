    ...
    <div class="max-w-7xl mx-auto px-5 pb-12">
        <div class="bg-white shadow-lg rounded-lg p-6 md:p-10">
            ...
            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-800 p-4 rounded mb-6">
                <p class="font-semibold">Hinweis zur Verlängerung deiner Regalmiete</p>
                <p class="text-sm mt-1">
                    Falls eine Verlängerung nicht möglich ist, kannst du ein neues Regal buchen. <br> 
                    Deine vorhandenen Produkte können in die neue Regalmiete übertragen werden.  <br> 
                    Bitte sende dazu einen kurzen Hinweis an den Support, damit die Übertragung durchgeführt werden kann.
                </p>
            </div>
            <!-- Regalmiete anzeigen -->
