        ...
        <div>
            ...
            <div x-show="showChat" x-cloak x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="relative w-full">
                        ...
                        <button @click="sendMessage()" class="absolute  right-3 top-1/2 -translate-y-1/2 bg-secondary rounded-radius px-2 py-1 text-xs tracking-wide text-on-primary transition hover:opacity-75 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:opacity-100 active:outline-offset-0 ">senden</button>
                </div>
            </div>
        </div>
    @endif
