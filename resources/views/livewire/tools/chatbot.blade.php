<div x-data="{ 
    ...
    @if($status)
        <div>
            <!-- Chatbot-Button -->
            <button x-show="!showChat" x-cloak  x-on:click="showChat = !showChat"  :class="{ 'bounce-in-right': !showChat }" class="fixed bottom-20 right-4 z-50 rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:outline-offset-0 " >
