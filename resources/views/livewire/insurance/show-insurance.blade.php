                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <div x-data="{ show: false }" class="relative">
                                            ...
                                            >
                                                ...
                                                Angezeigt ist der Gesamtwert aller Sparten.
                                                Für die ⌀ Auszahlungsdauer je Sparte bitte den Filter nutzen.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <x-filter.filter-container>
                    <x-slot name="filters">
                        ...
                        <div class="p-2 mb-2">
                            ...
                            <div wire:key="insurance-subtype-filter-{{ collect($insuranceSubTypes)->pluck('id')->implode('-') }}">
