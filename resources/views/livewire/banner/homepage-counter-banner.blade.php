<div class="bg-blue-50 py-12 text-center border-t border-gray-300">
    <div class="container mx-auto">
        <div class="flex justify-between gap-12 items-center text-center text-gray-800 p-8">
            ...
            >
                <svg class="w-12  aspect-square mx-auto text-secondary mb-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24">
            ...
            <div class="w-48 grid justify-center"
                ...
                x-init="$nextTick(() => start())"
            >
                <svg class="w-10  aspect-square mx-auto text-secondary mb-2" viewBox="0 0 24 24"  stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                <span class="text-4xl font-bold text-blue-900" x-text="counter">0</span>
                <p>Versicherungen</p>
