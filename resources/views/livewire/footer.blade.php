<footer x-data="{ screenWidth: window.innerWidth }" x-resize="screenWidth = $width"  class="footer  ">
    <div class=" tracking-wide  py-12 mb-16 sm:mb-12 md:mb-6 w-full px-1 md:px-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-x-6 gap-y-10">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false" >
                        <ul class="space-y-5 mt-6">
                            ...
                            <li>
                            <a  href="/howto" wire:navigate  class='hover:text-white text-white text-sm'>So funktionierts</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div x-data="{ open: false }" x-intersect.full.once="setTimeout(() => {open = true;}, 1000);">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false"  >
                        <ul class="space-y-5 mt-6 ">
                            <li>
                                <a  href="/abos" wire:navigate  class='hover:text-white text-white text-sm'>Abonnements</a>
                            </li>
                            <li>
                ...
                <div>
                    <ul class="md:flex md:space-x-6 max-md:space-y-2 max-sm:grid max-sm:grid-flow-row-dense max-sm:grid-cols-3 max-sm:grid-rows-3">
                        <li class="max-sm:col-span-2">
                            <a href="/termsandconditions" wire:navigate class='hover:text-white text-white text-sm '>AGB's</a>
                        </li>
                        <li class="max-sm:col-span-2">
                        ...
                        <li class="max-sm:inline-flex max-sm:place-self-end max-sm:w-max" >
                            <a class="" href="https://www.instagram.com/regulierungs_check?igsh=MWV2MWI5NTk0NWtscQ%3D%3D&utm_source=qr" target="_blank">
                                ...
                                class="fill-white w-7 h-7" viewBox="0 0 24 24">
                                <path
