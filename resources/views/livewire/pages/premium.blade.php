<div>
    <section class="text-gray-600 body-font overflow-hidden py-12">
        <div class="container mx-auto px-4 my-8">
            <div class="relative bg-blue-50 border border-blue-200 text-blue-900 px-6 py-5 rounded-md shadow-sm">
                <div class="absolute top-5 left-5">
                    <svg class="w-6 h-6 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10A8 8 0 1 1 2 10a8 8 0 0 1 16 0zm-9 4a1 1 0 1 0 2 0 1 1 0 0 0-2 0zm.25-8.75a.75.75 0 0 1 1.5 0v5a.75.75 0 0 1-1.5 0v-5z" clip-rule="evenodd" />
                    </svg>
                </div>
                <div class="pl-10">
                    ...
                    <p class="mb-4">
                        Unser Ziel ist es, mit zunehmender Datenbasis auch erweiterte Funktionen zur Verfügung zu stellen: Geplant sind Abonnements, die Zugriff auf <strong>vertiefte Auswertungsanalysen</strong>, <strong>erweiterte Filtermöglichkeiten</strong> sowie <strong>detaillierte Einblicke</strong> in branchenspezifische Trends und Vergleichsdaten bieten. Diese Funktionen richten sich vor allem an Nutzer:innen mit professionellem Interesse – etwa <strong>Versicherungsmakler</strong>, <strong>Anwälte</strong> oder <strong>Gutachter:innen</strong> – und nicht an reguläre Endverbraucher.
                    </p>
                    <p class="mb-4">
