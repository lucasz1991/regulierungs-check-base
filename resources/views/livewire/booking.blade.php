                    ...
                    <div class="flex items-center w-full">
                        ...
                        <div class="container mx-auto py-12" >
                            <div>
                                ...
                                <!-- Step 2 -->
                                <div
                                    x-data="{ XstartDate: null, XendDate: null, XisDateSelected: false }"
                                    x-show="showStep == 2" 
                                    x-effect="if(showStep === 2){setTimeout(() => {initializeCalendar();setTimeout(() => {$el.scrollIntoView({ behavior: 'smooth', block: 'end' });}, 500)}, 100)}"
                                    x-cloak  
                                    x-collapse.duration.1000ms
                                    id="alpine-calenderdata"
                                    >
                                    <div class="max-w-4xl mx-auto">
                                        <div  id="calender-container" class="scroll-py-6 snap-x overflow-hidden transition duration-1000 ease-in-out opacity-0" :class="showStep == 2 ? ' opacity-100 ' : ''">
                                            ...
                                            <div id="calender-confirm-button" class="flex justify-center mt-4 hidden">
                                                <button type="button" 
                                                        wire:click="setData(XstartDate, XendDate)" 
                                                        x-data="{ isClicked: false }" 
                                                        @click="isClicked = true; setTimeout(() => isClicked = false, 100)"
                                                        style="transform:scale(1);"
                                                        :style="isClicked ? 'transform:scale(0.7);' : 'transform:scale(1);'"
                                    ...
                                    @assets
                                        ...
                                        <script src="/adminresources/js/calender-init.js"></script>
                                    @endassets
                                ...
                                @script
                                    <script>
                                        window.initializefloorplan = async function() {
                                            ...
                                            console.log('initializefloorplan');
                                                        ...
                                                        <div>
                                                            ...
                                                            @if ($isDiscounted)
                                                                ...
                                                                <p class="text-red-600 font-medium">
                                                                    🎁 {{ $bestBonus->name }}: {{ number_format($discountedPrice, 2, ',', '.') }} €
                                                                </p>
                                                            @else
