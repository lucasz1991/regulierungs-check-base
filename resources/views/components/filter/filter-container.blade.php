    ...
    <div class="container mx-auto p-4 pb-8">
        ...
        <div class="xl:grid xl:grid-cols-12 xl:gap-6">
            ...
            <div x-show="showFilters || $store.nav.isScreenXl"  x-cloak class="filter-sidebar xl:col-span-3 max-xl:absolute max-xl:right-4 z-10">
                ...
                <div x-show="showFilters  || $store.nav.isScreenXl" x-transition x-ref="filterPanel" class="relative flex  w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border border border-gray-300 p-2 text-gray-700 shadow-xl shadow-gray-900/5  z-20">
                    {{ $filters }}
                </div>
            </div>
