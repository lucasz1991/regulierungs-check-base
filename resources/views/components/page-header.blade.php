    @if ($isWebPage && $showHeader)
        <header class="relative bg-cover min-h-32  px-8 " style="background-image: url('{{ $header_image_url ? $header_image_url : asset('site-images/background.jpg') }}'); background-position: {{ $header_image_positioning }};">
