...
<div class="block" x-data="{ hover: false }" @click.away="showInfos = false" x-cloak>
    <div class="bg-white px-2 py-2 relative transition-shadow duration-300 flex flex-col justify-between h-full  hover:shadow-lg  cursor-pointer border-gray-300 border   rounded shadow"
            ...
            <div class="shrink-0 transition-all relative self-auto" >
                ...
                <div class="mt-3">
                    <div class="text-sm text-gray-500 font-medium text-center mb-3">
                        <span class="text-sm text-gray-700 py-0.5 px-1 bg-white border border-gray-300 rounded-lg">Ø: {{ $insurance->avgRatingDurationBySubtype($subTypeFilterSubType?->id) }} Tage</span>
                    </div>
                    <div class="flex items-center justify-center text-sm text-gray-500 font-medium">
