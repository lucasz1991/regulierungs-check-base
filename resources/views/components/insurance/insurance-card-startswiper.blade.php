...
<a href="{{ route('insurance.show-insurance', $insurance->slug) }}" class="block  hover:shadow-lg  cursor-pointer   rounded shadow" x-data="{ hover: false }" @click.away="showInfos = false" x-cloak>
