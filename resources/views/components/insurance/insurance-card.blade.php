        ...
        <div class=" transition-all duration-200">
            <div  class="flex gap-2">
                ...
                <div class="shrink-0 transition-all " 
                    ...
                    <div class="h-full bg-primary border-l border-secondary rounded-e pb-1 pt-3 px-1 flex  items-end relative " style="">
                        <div class="mt-2">
