...
@php
    ...
    if ($hasTypeFilter || $hasSubtypeFilter) {
        ...
        $avgDuration = $insurance->avgRatingDurationBySubtype(null);
        $avgScore = $insurance->ratings_avg_score();
        $ratingsCount = $insurance->claimRatingsCountBySubtype(null);
    }
                        ...
                        <div  class="">
                            <div class="mt-1">
                                <div class="text-sm text-gray-500 font-medium text-center">
                                    <div class="w-14 h-14 mx-auto text-xs text-white p-1 aspect-square  bg-secondary-light ring-2 ring-offset-2 ring-secondary-light  rounded-full flex justify-center items-center"><span>Ø: {{ round($avgDuration) }}<br> Tage</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
