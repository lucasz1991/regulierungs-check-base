...
<div class="block" x-data="{ showInfos: false, hover: false }" @click.away="showInfos = false" x-cloak>
    <div class="bg-white px-4 py-4 relative transition-shadow duration-300 flex flex-col justify-between h-full  hover:shadow-lg  cursor-pointer pb-4 z-10"
            ...
            <div class="shrink-0 transition-all relative self-auto" 
                ...
                <div  class="flex items-center justify-between gap-2 mb-2" >
                    ...
                    <span class=" bg-gray-100 text-gray-800 text-xs font-medium  px-2 pr-2.5 py-0.5 rounded-xl  border border-gray-500 w-max opacity-60 ">
                        ...
                        {{ $insurance->claimRatingsCountBySubtype($subTypeFilterSubType?->id) }}
                    </span>
                </div>
            </div>
