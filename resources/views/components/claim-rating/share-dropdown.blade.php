@props(['claimRating' => null])

<div x-data="{ open: false }" class="relative">
    <!-- Button zum Öffnen des Dropdowns -->
    <button @click="open = !open" title="Teilen"
        ...
        <svg class="w-4 aspect-square" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M49.54,44.34a7.81327,7.81327,0,0,0-6.59,3.61L21.69,35.67a7.797,7.797,0,0,0-.22-6.48l-.0011-.002L43.3233,16.57391A7.81769,7.81769,0,1,0,41.71,11.83a7.56556,7.56556,0,0,0,.61,3.01l.00128.00268L20.35907,27.519A7.837,7.837,0,1,0,20.69,37.4L42.09,49.76a7.69578,7.69578,0,0,0-.38,2.41,7.83,7.83,0,1,0,7.83-7.83Z"/>
        </svg>
    </button>
    ...
    <div x-show="open" x-cloak @click.away="open = false" class="absolute right-4 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-40">
        <ul>
            <!-- WhatsApp Share -->
            <li>
                <a href="https://wa.me/?text={{ urlencode('Bewertung teilen: ' . request()->fullUrl() ) }}" 
                   target="_blank"
