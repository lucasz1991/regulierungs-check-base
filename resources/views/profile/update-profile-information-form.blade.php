<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="email" type="email" class="mt-1 block w-full @if($this->user->email_verified_at) ring  ring-offset-4 ring-green-200  @endif" wire:model="state.email" required autocomplete="username" />
