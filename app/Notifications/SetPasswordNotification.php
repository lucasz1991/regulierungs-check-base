...
class SetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Herzlich willkommen bei MiniFinds! Setze dein Passwort')
            ->greeting('Hallo ' . $this->user->name . '!')
            ->line('Wir freuen uns sehr, dich als neuen Verkäufer bei MiniFinds willkommen zu heißen!')
            ...
            ->salutation('dein MiniFinds Team');
    }
